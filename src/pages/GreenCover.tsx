...
export default function GreenCover() {
  ...
  return (
    <div className="map-page-container page-transition pt-16 flex md:flex-row flex-col h-[100dvh] overflow-hidden">
      ...
      {/* ── Sidebar ─────────────────────────────────────────────────────── */}
      <div className="map-sidebar bg-card border-r border-border flex flex-col gap-4 p-4 relative z-10 shadow-xl overflow-y-auto w-full md:w-[340px] shrink-0">
        ...
        {/* YEAR TOGGLE (Requested specifically underneath 16.2% stat or at top, user implies top area) */}
        <div className="year-toggle md:static md:w-full md:transform-none md:p-0 md:bg-transparent md:border-none md:shadow-none md:justify-start">
        ...
        {/* NDVI trend chart */}
        <div className="bg-[#0f172a] rounded-xl p-4 shadow-inner mt-2 flex flex-col h-[160px]">
